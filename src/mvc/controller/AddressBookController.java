    ...
    private void openAdd(){   
       view.getMainGUIFrame().setVisible(false);
        ...
        choiceListener = new ActionListener() {
            ...
            String Qualification = contactDetailsPanel.getQualification().getText(); 
            flag = validate();
            mobval=mobvalid();
            if(flag && mobval)
            {    
             Person person = new Person();
             person.setData(name,mobile,email,Qualification);
   ...
   */
    ...
    public boolean mobvalid(){
        ...
        if(mobile.length()>10 || mobile.length()<10)
         JOptionPane.showMessageDialog(new JFrame(),"mobile number should be 10","Inane error", JOptionPane.ERROR_MESSAGE);   
        else
            valid=true;
        return valid;
    }
    ...
    private void openEdit(){
        ...
        dialog.getPanel().setQualification(detailPanel.getQualification().getText());
        view.getMainGUIFrame().setVisible(false);
        choiceListener = new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
    ...
    public void openSearch(){
         final String name=detailPanel.getNameField().getText();
        String Str=JOptionPane.showInputDialog(null,"Enter the string","search",1);
        }
    public void loadPersons()       
    {
        ...
        nlp.getJList().addListSelectionListener(new ListSelectionListener()
         ...
         detailPanel.getQualification().setEditable(false);
